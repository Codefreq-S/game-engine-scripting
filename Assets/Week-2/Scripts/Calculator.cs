...
public class Calculator : MonoBehaviour
{
    ...
    public TextMeshProUGUI GUI_Text;
    ...
    public void AddInput(string input)
    {
        ...
        //string Hint = input; //NOTE TO SELF: This is just a guess based on interpretation of the above comment...
        //                     //I'm not sure what the directions mean by the label "Hint"
    }
    ...
    public void SetEquationAsAdd()
    {
        ...
        prevInput = float.Parse(GUI_Text.text);
        clearPrevInput = true;
    ...
    public void Add()
    {
        ...
        //prevInput = float.Parse(GUI_Text.text);
        GUI_Text.text = (prevInput + float.Parse(GUI_Text.text)).ToString();
    }
