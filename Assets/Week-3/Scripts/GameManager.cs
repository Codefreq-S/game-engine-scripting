...
//
// Assisted by Tutors: Grace Anders; Sally Juettner
//
...
namespace Battleship
{
    public class GameManager : MonoBehaviour
    {
        ...
        //Total rows and columns we gave
        private int nRows;
        private int nCols;
        ...
        private int time;
        //For Random Number Generator within a specified range
        ...
        private void Awake()
        {
            ...
            {
                //Create an instance of the prefab and child to the gridRoot
        ...
        void UnShowHit(int h)
        {
            //Get the current cell
            Transform cell = GetCurrentCell();
            //Set the "Hit" image on
            Transform hit = gridRoot.GetChild(h).Find("Hit");
        ...
        void UnShowMiss(int m)
        {
            //Get the current cell
            Transform cell = GetCurrentCell();
            //Set the "Miss" image on
            Transform miss = gridRoot.GetChild(m).Find("Miss");
        ...
        public void ResetGame()
        {
            ...
            //and randomize each value to be either 0 or 1

            //foreach (int i in grid)
            //{
            //    grid = Random.Range(0, 1); // TODO: Randomly generate a number
            //}
            ...
            for (int c = 0; c < nCols; c++)
            {
                ...
                for (int r = 0; r < nRows; r++)
                {
                    ...
                    grid[c, r] = rand; // resets all array integers to "0"; if randomized, use rInt
